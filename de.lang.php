...
$lang = [
    ...
    'error.register.blocked' => 'Dieser Registrierungsversuch wurde geblockt..',

    'general.advertisement' => 'Werbung',
    'general.users-online' => 'Es sind %1 Nutzer online!',
    'general.welcome' => 'Willkommen im %1',
    'general.register-now' => 'Registriere dich im %1',
    'general.enter-hotel' => 'Ins %1!',
    ...
    'register.login' => 'Du hast bereits einen Account?',
    ...
    'register.account-created' => 'Herzlichen Glückwunsch! Dein Account wurde erstellt. Überprüfe deine E-Mail für die Aktivierung. TIPP: Gucke auch in deinen Spam/Müll Ordner.',
    ...
    'user.settings.my-status' => 'Mein Motto',
    'user.settings.my-status.description' => 'Wie lautet dein Motto?',
    ...
    'community' => 'Community',
    'community.staff' => 'Mitarbeiter',
    'community.staff.staff-on-hotel' => 'Mitarbeiter im %1',
    'community.richest-members' => 'Reichste Nutzer',

    'admin' => 'Housekeeping',
    'admin.dashboard' => 'Dashboard',
    'admin.welcome' => 'Willkommen, %1',
    'admin.settings' => 'Einstellungen',

    'admin.settings.cms' => 'CMS-Einstellungen',
    'admin.settings.client' => 'Client Einstellungen',
    'admin.settings.plugin' => 'Plugineinstellungen',
    'admin.settings.register' => 'Registrations Einstellungen',
    'admin.settings.setting.base_url' => 'Standard URL',
    'admin.settings.setting.hotel_name' => 'Hotelname',
    ...
    'admin.settings.setting.password_min_length' => 'Mindest Passwortlänge',
    ...
    'admin.settings.setting.register_activity_points' => 'Akitivitätspunkte neuer Nutzer',
    'admin.settings.setting.register_credits' => 'Credits neuer Nutzer',
    'admin.settings.setting.register_vip_points' => 'VIP Punkte neuer Nutzer',
    'admin.settings.setting.register_look' => 'Aussehen neuer Nutzer',
    'admin.settings.setting.register_motto' => 'Motto neuer Nutzer',
    ...
    'admin.news.creation-error' => 'Etwas ist während des speicherns schiefgegangen.',
    ...
    'admin.plugins.disable' => 'Plugin deaktivieren',
    'admin.plugins.enable' => 'Plugin aktivieren',
    'admin.plugins.no-enabled' => 'Es ist derzeit kein Plugin aktiviert',
    'admin.plugins.no-disabled' => 'Es ist derzeit kein Plugin deaktiviert',
    ...
    'admin.plugins.couldnt-save' => 'Etwas ist während des speicherns schiefgegangen',

    'admin.pages' => 'Seiten',
    'admin.pages.edit' => 'Seite bearbeiten: %1',
    'admin.pages.name' => 'Seitenname',
    'admin.pages.access-level' => 'Zugriffsebene',
    ...
    'admin.pages.add-column' => 'Spalte hinzufügen',
];
